...
dependencies {
    runtimeOnly("net.darkhax.bookshelf:bookshelf-fabric-1.21.1:${Versions.BOOKSHELF}")
    runtimeOnly("net.darkhax.enchdesc:enchdesc-fabric-1.21.1:${Versions.ENCHANTMENT_DESCRIPTIONS}")
}
